...
import { buildAdminPath, parseAdminAffiliatePayoutsParams } from '@/modules/admin-shell/query';
...
export default async function AdminAffiliatePayoutsRoute({ searchParams }: AdminAffiliatePayoutsRouteProps) {
  ...
  return <AdminAffiliatePayoutsPage session={session} filters={filters} isCreateOpen={isCreateOpen} />;
}
