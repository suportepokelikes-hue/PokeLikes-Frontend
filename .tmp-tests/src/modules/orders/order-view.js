...
exports.getOrderStatusView = getOrderStatusView;
exports.getOrderEventView = getOrderEventView;
exports.sortOrderEvents = sortOrderEvents;
exports.orderHasQueuedSupplierBalance = orderHasQueuedSupplierBalance;
...
function getOrderEventView(event, audience) {
...
function orderHasQueuedSupplierBalance(order) {
    if (order.status === 'queued_supplier_balance') {
        return true;
    }
    return sortOrderEvents(order.events).some((event) => event.fromStatus === 'queued_supplier_balance' || event.toStatus === 'queued_supplier_balance');
}
function getOrderEventLabel(eventType) {
